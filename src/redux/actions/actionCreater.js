  ...
  return async (dispatch) => {
    ...
    try {
      const result = await axios.post(
        `https://www.cheaposervice.com/Order26.QA.AppLayer/MarketPlace/Login?UserId=${email}&password=${password}`
      );
      dispatch({
        type: AT.SET_USER,
        payload: result.data,
...
const getEmployee = (data) => {
  ...
  return async (dispatch) => {
    ...
    try {
      const result = await axios.get(
        "https://www.cheaposervice.com/Order26.QA.AppLayer/MarketPlace/employee?pageNumber=0&PageSize=20",
        {
          headers: {
            "Content-Type": "application/json",
            "X-TOKEN": token,
...
const getOrders = (data) => {
  ...
  return async (dispatch) => {
    ...
    try {
      const result = await axios.get(
        "https://www.cheaposervice.com/Order26.QA.AppLayer/MarketPlace/order?pageNumber=0&PageSize=20",
        {
          headers: {
            "Content-Type": "application/json",
            "X-TOKEN": token,
